...
def get_location():
    ...
    LOC_API_KEY = loc_key
    response = requests.get(LOC_URL, headers={'X-Api-Key': loc_key})
...
def get_weather():
    ...
    WEATHER_URL = f"https://api.openweathermap.org/data/2.5/weather?lat={lat}&lon={long}&appid={weather_key}&units=imperial"
